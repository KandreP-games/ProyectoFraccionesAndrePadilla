 ...
 * No implementamos la función simplifica porque ya se ha hecho en simplificarFracciones
 * Aun así, la utilizamos en las funciones de suma, multiplicación y división
 * CUIDADO al hacer merge en la branch develop
 */
